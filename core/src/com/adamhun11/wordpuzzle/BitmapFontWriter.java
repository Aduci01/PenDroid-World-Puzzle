 ...
 * times.
 *
 * The lvlFont format is from the AngelCodeFont BMFont tool.
 *
...
public class BitmapFontWriter {
    ...
    /** The lvlFont "info" line; this will be ignored by LibGDX's BitmapFont reader,
    ...
    public static class FontInfo {
        ...
        /** Font size (pt) */
        public int size = 12;
        /** Whether the lvlFont is bold */
        public boolean bold;
        /** Whether the lvlFont is italic */
        public boolean italic;
        /** The charset; or null/empty for default */
        public String charset;
        /** Whether the lvlFont uses unicode glyphs */
        public boolean unicode = true;
        /** Stretch for height; default to 100% */
        public int stretchH = 100;
        /** Whether smoothing is applied */
        public boolean smooth = true;
        /** Amount of anti-aliasing that was applied to the lvlFont */
        public int aa = 2;
        /** Padding that was applied to the lvlFont */
        public Padding padding = new Padding();
        /** Horizontal/vertical spacing that was applied to lvlFont */
     ...
     *
     * The FontInfo parameter is useful for cleaner output; such as including a size and lvlFont face name hint. However, it can be
    ...
    /** A utility method which writes the given lvlFont data to a file.
     *
     ...
     * </pre>
     *
     * @param fontData the lvlFont data
     * @param pages the pixmaps to write as PNGs
     * @param outFntFile the output file for the lvlFont definition
     * @param info the optional lvlFont info for the header file, can be null */
